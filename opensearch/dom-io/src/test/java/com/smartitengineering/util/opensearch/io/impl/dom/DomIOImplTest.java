...
public class DomIOImplTest extends TestCase {
  ...
  public static OpenSearchDescriptor MIN_DESC = OpenSearchAPIBuilders.getOpenSearchDescriptorBuilder().shortName(
  ...
  public static OpenSearchDescriptor MAX_DESC = OpenSearchAPIBuilders.getOpenSearchDescriptorBuilder().shortName(
      "testDesc").description("Some test description").urls(OpenSearchAPIBuilders.getUrlBuilder().template(
      ...
      count(3).startIndex(0).startPage(3).totalResults(2).customAttribute("xmlns:cns", "http://google.com/1.1").
